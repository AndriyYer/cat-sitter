                        ...
                        <DialogPanel className="w-full max-w-lg rounded-lg bg-white p-6 shadow-md">
                            ...
                            <div className="mt-5">
                                ...
                                <p className="mb-2 text-xs italic text-gray-500">
                                    Providing your phone number is optional, but
                                    I already paid for the text messages so you
                                    might as well. If you do, you'll recieve a
                                    text the day before your scheduled visit.
                                </p>
                                <input
                                    id="phoneNumber"
                                    type="text"
