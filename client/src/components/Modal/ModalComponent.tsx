                        ...
                        <DialogPanel className="w-full max-w-lg rounded-lg bg-white p-6 shadow-md">
                            ...
                            <div className="mt-5">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
                                />
                            </div>
                            ...
                            <div className="mt-5">
                                ...
                                <p className="mb-2 text-xs italic text-gray-500">
                                    Providing your phone number is optional. If
                                    you do, you'll receive a text reminder the
